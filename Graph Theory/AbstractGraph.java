...
public abstract class AbstractGraph<V> implements Graph<V> 
{
    ...
    public int countEdges() {
        ...
        // Recursively search
        countEdges(0, parent, searchOrder, isVisited, edges);
    ...
    /** Recursive method for DFS search */
    private void countEdges(int u, int[] parent, List<Integer> searchOrder, boolean[] isVisited, int edges) {
        // Store the visited vertex
        searchOrder.add(u);
        isVisited[u] = true; // Vertex v visited
        ...
        for (Edge e : neighbors.get(u)) {
            if (!isVisited[e.v]) {
                parent[e.v] = u; // The parent of vertex e.v is u
                countEdges(e.v, parent, searchOrder, isVisited, edges); // Recursive search
            }
        }
    }
    ...
    public class Tree
    {
        ...
        public List<Integer> getPath2(int index) {
